...
rp = RunParams(dataFile = 'z4a10.pickle',
               ...
               observables = [{'id': 'e', 'drawPlot': False, 'invert': False,
                               ...
                               'xlabel': r'N$_{max}$'},
                              {'id': 'rc', 'drawPlot': True, 'invert': False,
                               'performFit': True, 'fitFunction': 'reciprocal',
                               'ylabel': r'r$_c$ []', 'xlabel': r'N$_{max}$'},
                              {'id': 'rn', 'drawPlot': True, 'invert': False,
                               'performFit': True, 'fitFunction': 'reciprocal',
                               'ylabel': r'r$_n$ []', 'xlabel': r'N$_{max}$'},
                              {'id': 'rp', 'drawPlot': True, 'invert': False,
                               'performFit': True, 'fitFunction': 'reciprocal',
                               'ylabel': r'r$_p$ []', 'xlabel': r'N$_{max}$'}],
